						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    						...
    						if(isset($_GET['details']))
    						{
    							$product_id=$_GET['details'];
  		     			 		$query="SELECT * FROM product where product_id='{$_GET['details']}';";
    						...
    						if(isset($_GET['cart']))
    						{
								...
								$product_id=$_GET['cart'];
  		     			 		$query="SELECT * FROM product where product_id='{$_GET['cart']}';";
  		      					$result=mysqli_query($connected,$query);
  		      					if(!$result)
  		      					{
  		      					echo mysqli_error($connected);
				...
				<div class=\"col-lg-5 offset-lg-1\">
					<div class=\"s_product_text\">
						...
						<ul class=\"list\">
							<li>
								<a class=\"active\" href=\"#\">
									<span>Category</span> : Desktop</a>
							</li>
							<li>
								<a href=\"#\">
									<span>Availibility</span> : {$quantity}</a>
							</li>
						...
						<div class="card_area">
							<a class="main_btn" href="?cart=<?php echo $_GET['details']; ?>">Add to Cart</a>
